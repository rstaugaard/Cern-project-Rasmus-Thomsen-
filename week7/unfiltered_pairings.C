...
TH1F *htwo_cut = new TH1F("htwo_cut","htwo_cut",130,0.2,1.6);
TH1F *hfour_cut = new TH1F("hfour_cut","hfour_cut",100,1.1,3.5);
...
void unfiltered_pairings()
{
	...
	if (vector_sum(red_particle1,red_particle2)/mpi < 0.2 || vector_sum(red_particle1,red_particle3)/mpi < 0.2 || vector_sum(red_particle1,red_particle4)/mpi < 0.2 || vector_sum(red_particle2,red_particle3)/mpi < 0.2 || vector_sum(red_particle2,red_particle4)/mpi < 0.2 || vector_sum(red_particle3,red_particle4)/mpi < 0.2)
	{
