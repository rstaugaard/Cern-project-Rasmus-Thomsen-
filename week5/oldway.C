...
{
   Double_t bp[4] = {7.23281e+04, 2.37441e-01, 1.15968e+00 , 4.88352e+00};
   //Double_t pars1[4] = {par[0],par[1],par[2],par[3]};
   Double_t pars2[3] = {par[0],par[1],par[2]};
   Double_t pars3[3] = {par[0],par[3],par[4]};
...
{
    Double_t arglist[5] = {1.34362e+03,7.49886e-01,6.04308e-02,4.97597e-01,1.80171e-02};
    ...
    gMinuit2->mnparm(3, "mu2", arglist[3], 0.0001, 0, 0, ierflg);
...
void oldway()
{
    ...
    {
        Double_t params1[3] = {params[0],params[3],params[4]};
        x1[i] = 0.45+i*0.0003;
    ...
    for (Int_t i=0;i< 300;i++) 
    {
        Double_t back_params[4] = {7.23281e+04, 2.37441e-01, 1.15968e+00 , 4.88352e+00};
    ...
    legend->AddEntry(g3,"#splitline{Kaon peak:}{ #splitline{#mu = 0.497 #pm 0.001 GeV}{#sigma = 0.014 #pm 0.001 GeV}}","l");
    legend->AddEntry(g4,"#splitline{Rho peak:}{ #splitline{#mu = 0.739 #pm 0.001 GeV}{#sigma = 0.068 #pm 0.001 GeV}} ","l");
    legend->AddEntry(g2,"Total fit: Chi2 / NDof : 304 / 176","l");
